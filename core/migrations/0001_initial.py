# Generated by Django 4.2.27 on 2026-06-12 14:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "leader_name",
                    models.CharField(max_length=100, verbose_name="Nome do Líder"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "paused_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Pausado em"
                    ),
                ),
                (
                    "resumed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Retomado em"
                    ),
                ),
                (
                    "completed_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Nome da Máquina"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "SISTEMA_VULCANIZACAO",
                                "Sistema de Vulcanização (Mecânico)",
                            ),
                ...
                (
                    "item_name",
                    models.CharField(max_length=255, verbose_name="Nome do Item"),
                ),
                (
                    "status",
                    models.CharField(
                        blank=True,
                        choices=[("C", "Conforme"), ("NC", "Não Conforme")],
                        max_length=2,
                        null=True,
                        verbose_name="Status",
                    ),
